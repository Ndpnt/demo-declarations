# Declarations of terms tracked in the *demo* collection

The terms in this collection are declared by _ _ _ _ _ ✍️ and tracked using [Open Terms Archive](https://opentermsarchive.org).

You can [explore the tracked versions](https://github.com/Ndpnt/demo-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/demo-versions/releases) in the `Ndpnt/demo-versions` repository.
